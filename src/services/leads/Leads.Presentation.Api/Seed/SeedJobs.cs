    ...
    public static class SeedJobs
    {
        ...
        private static IEnumerable<Job> SeedData() => new List<Job>
        {
            ...
            new Job(
                ...
                2,
                2,
                Guid.Parse( "2a884e74-9824-11ea-bb37-0242ac130002" )
            ),
            new Job(
                45,
                "Aliquam posuere est sit amet libero egestas tempus. Donec ut "
                ...
                3,
                3,
                Guid.Parse( "52b1ebda-9824-11ea-bb37-0242ac130002" )
            ),
            new Job(
                15,
                "Proin semper consectetur mauris id commodo. In accumsan est ligula, "
                ...
                4,
                4,
                Guid.Parse( "9fea77dc-9824-11ea-bb37-0242ac130002" )
            ),
            new Job(
                62,
                "Quisque blandit erat id mi tincidunt porta. Vivamus eleifend "
                ...
                5,
                5,
                Guid.Parse( "be1cff4a-9824-11ea-bb37-0242ac130002" )
            ),
            new Job(
                55,
                "Suspendisse consequat malesuada arcu id venenatis. Donec maximus, "
                ...
                1,
                6,
                Guid.Parse( "d99ffe16-9824-11ea-bb37-0242ac130002" )
            )
        };
    }
}