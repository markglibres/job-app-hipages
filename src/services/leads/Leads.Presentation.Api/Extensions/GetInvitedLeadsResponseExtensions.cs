...
namespace Leads.Presentation.Api.Extensions
{
    ...
    {
        public static dynamic ToHal( this GetInvitedLeadsResponse response,
            HttpRequest request
        )
        {
            ...
            var embedded = response
                ...
                .Select(
                    lead =>
                    {
                        var stringObject = JsonConvert.SerializeObject(
                            lead,
            ...
            halObject.Add( "_embedded", new Dictionary<string, object> { { "leads", embedded.ToArray() } } );
